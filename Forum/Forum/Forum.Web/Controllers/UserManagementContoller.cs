...
namespace Forum.Web.Controllers
{
    ...
    public class UserManagementController: Controller
    {
        ...
        {
            var usersWithRoles = await _userManagementService.GetAllAsync();
        ...
        public async Task<IActionResult> Manage(string userId)
        {
            ...
            var model = await _userManagementService.GetAsync(userId);
            return View(model);
        }
        ...
        {
            await _userManagementService.BanUserAsync(userId);
            return RedirectToAction("Index");

        }
        public async Task<IActionResult> UnbanUser(string userId)
        {
            await _userManagementService.UnbanUserAsync(userId);
            return RedirectToAction("Index");
